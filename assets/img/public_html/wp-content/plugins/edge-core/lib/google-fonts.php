<?php
if ( ! function_exists( 'adorn_edge_init_google_fonts_array' ) ) {
    function adorn_edge_init_google_fonts_array() {
    ...
    add_action('after_setup_theme', 'adorn_edge_init_google_fonts_array');
}